...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  public ModuleIOTalonFX(
    ...
    turnTalon.setPosition(turnAbsolutePosition.getValue().in(Rotations), 1.0);
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    inputs.turnPosition = Rotation2d.fromDegrees(turnPosition.getValue().in(Degrees) % 360.0);
  ...
  public void setDriveVelocity(double velocityRadPerSec) {
    ...
    AngularVelocity vel = RadiansPerSecond.of(velocityRadPerSec);
    driveTalon.setControl(
        switch (constants.DriveMotorClosedLoopOutput) {
          case Voltage -> velocityVoltageRequest.withVelocity(vel);
          case TorqueCurrentFOC -> velocityTorqueCurrentRequest.withVelocity(velocityRotPerSec);
        });
  }

  @Override
  public void setDriveVelocity(double velocityRadPerSec, double ff) {
    double velocityRotPerSec = Units.radiansToRotations(velocityRadPerSec);
    AngularVelocity vel = RadiansPerSecond.of(velocityRadPerSec);
    driveTalon.setControl(
        switch (constants.DriveMotorClosedLoopOutput) {
          case Voltage -> velocityVoltageRequest.withVelocity(vel).withFeedForward(ff);
          case TorqueCurrentFOC -> velocityTorqueCurrentRequest.withVelocity(velocityRotPerSec);
        });
  }
